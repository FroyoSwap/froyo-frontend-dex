...
1. Fork the [FroyoSwap Dex Frontend](https://github.com/froyoswap/froyo-frontend-dex/) repository on GitHub
...
3. Add your **token information** using the example format provided below to `froyoswap.json` in the `/src/constants/token/` directory.
...
```json
{
"name": "FroyoSwap Token",
"symbol": "FROYO",
"address": "0x1f546ad641b56b86fd9dceac473d1c7a357276b7",
"chainId": 56,
"decimals": 18,
"logoURI": "/images/coins/FROYO.png"
},
```

If you're not comfortable with GitHub pull requests, please open a [new issue](https://github.com/froyoswap/froyo-frontend-dex/issues/new) requesting to be added.
